...
The Dolphain Web Portal runs the library entirely in the browser using Pyodide. To develop for the portal:

### 1. Build the Wheel
The portal requires a `.whl` file of the library to be present in `site/portal/`.
